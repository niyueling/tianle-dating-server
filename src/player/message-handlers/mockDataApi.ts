...
export class MockDataApi extends BaseApi {
  ...
  async saveTaskData() {
    ...
    async saveRegressionTaskData() {
        ...
        const datas1 = [
            ...
            {type: 2, taskPrizes: [{number: 200, type: 1},{number: 1, type: 10, propId: 1310}], liveness: 200},
            {type: 2, taskPrizes: [{number: 200, type: 1},{number: 1, type: 10, propId: 1311}], liveness: 500},
        ];
  ...
  async saveGoodsDailyTlGolds() {
    ...
    const datas = [
      {level: 1, price: 6, originPrice: 22, gold: 500000000, todayReceiveLimit: 3, maxReceiveDayLimit: 7, todayReceiveGold: 50000, gameType: "majiang"},
      {level: 2, price: 30, originPrice: 1250, gold: 2000000000, todayReceiveLimit: 3, maxReceiveDayLimit: 7, todayReceiveGold: 200000, gameType: "majiang"},
      {level: 3, price: 128, originPrice: 24200, gold: 200000000000, todayReceiveLimit: 3, maxReceiveDayLimit: 7, todayReceiveGold: 20000000, gameType: "majiang"},
    ];
