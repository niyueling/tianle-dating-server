...
export class MockDataApi extends BaseApi {
  ...
  async saveTaskData() {
    ...
    const datas = [
      // 成长成就-钻石王老五
      {taskName: "钻石王老五", taskDescribe: "拥有钻石数大于?/88", taskType: 1, taskId: 1001, taskTimes: 88, typeId: 1,
        taskPrizes: {name: "50万金豆", number: 500000, type: 2}, taskDesignates: {title: "钻石王老五", propId: 1122, taskTimes: 8888}, liveness: 10},
      {taskName: "钻石王老五", taskDescribe: "拥有钻石数大于?/388", taskType: 1, taskId: 1002, taskTimes: 388, typeId: 1,
        taskPrizes: {name: "50万金豆", number: 500000, type: 2}, taskDesignates: {title: "钻石王老五", propId: 1122, taskTimes: 8888}, liveness: 10},
      {taskName: "钻石王老五", taskDescribe: "拥有钻石数大于?/888", taskType: 1, taskId: 1003, taskTimes: 388, typeId: 1,
        taskPrizes: {name: "50万金豆", number: 500000, type: 2}, taskDesignates: {title: "钻石王老五", propId: 1122, taskTimes: 8888}, liveness: 10},
      {taskName: "钻石王老五", taskDescribe: "拥有钻石数大于?/2888", taskType: 1, taskId: 1004, taskTimes: 2888, typeId: 1,
        taskPrizes: {name: "50万金豆", number: 500000, type: 2}, taskDesignates: {title: "钻石王老五", propId: 1122, taskTimes: 8888}, liveness: 10},
      {taskName: "钻石王老五", taskDescribe: "拥有钻石数大于?/5888", taskType: 1, taskId: 1005, taskTimes: 5888, typeId: 1,
        taskPrizes: {name: "50万金豆", number: 500000, type: 2}, taskDesignates: {title: "钻石王老五", propId: 1122, taskTimes: 8888}, liveness: 10},
      {taskName: "钻石王老五", taskDescribe: "拥有钻石数大于?/8888", taskType: 1, taskId: 1006, taskTimes: 8888, typeId: 1,
        taskPrizes: {propId: 1122, number: 1, type: 4}, taskDesignates: {title: "钻石王老五", propId: 1122, taskTimes: 8888}, liveness: 10},

      // 成长成就-零号玩家
      {taskName: "零号玩家", taskDescribe: "累计签到天数达到?/7天", taskType: 1, taskId: 1007, taskTimes: 7, typeId: 2,
        taskPrizes: {name: "20万金豆", number: 200000, type: 2}, taskDesignates: {title: "零号玩家", propId: 1118, taskTimes: 100}, liveness: 5},
      {taskName: "零号玩家", taskDescribe: "累计签到天数达到?/14天", taskType: 1, taskId: 1008, taskTimes: 14, typeId: 2,
        taskPrizes: {name: "20万金豆", number: 200000, type: 2}, taskDesignates: {title: "零号玩家", propId: 1118, taskTimes: 100}, liveness: 5},
      {taskName: "零号玩家", taskDescribe: "累计签到天数达到?/30天", taskType: 1, taskId: 1009, taskTimes: 30, typeId: 2,
        taskPrizes: {name: "20万金豆", number: 200000, type: 2}, taskDesignates: {title: "零号玩家", propId: 1118, taskTimes: 100}, liveness: 5},
      {taskName: "零号玩家", taskDescribe: "累计签到天数达到?/58天", taskType: 1, taskId: 1010, taskTimes: 58, typeId: 2,
        taskPrizes: {name: "20万金豆", number: 200000, type: 2}, taskDesignates: {title: "零号玩家", propId: 1118, taskTimes: 100}, liveness: 5},
      {taskName: "零号玩家", taskDescribe: "累计签到天数达到?/88天", taskType: 1, taskId: 1011, taskTimes: 88, typeId: 2,
        taskPrizes: {name: "20万金豆", number: 200000, type: 2}, taskDesignates: {title: "零号玩家", propId: 1118, taskTimes: 100}, liveness: 5},
      {taskName: "零号玩家", taskDescribe: "累计签到天数达到?/100天", taskType: 1, taskId: 1012, taskTimes: 100, typeId: 2,
